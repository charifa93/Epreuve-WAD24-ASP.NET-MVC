CREATE TABLE [dbo].[Emprunt] (
    ...
    [EvaluationPreteur]    INT              NOT NULL,
    [EvaluationEmprunteur] INT              NOT NULL,
    PRIMARY KEY CLUSTERED ([EmpruntId] ASC),
    CHECK ([EvaluationEmprunteur]>=(1) AND [EvaluationEmprunteur]<=(5)),
    CHECK ([EvaluationPreteur]>=(1) AND [EvaluationPreteur]<=(5)),
